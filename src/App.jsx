...
const products = [
  ...
  },
  {
    ...
    price: "$1",
    tag: "Utility",
    imageUrl: "https://placehold.co/1280x720/141414/facc15?text=BMTB+Wigs",
    ...
    <>
      ...
      <section id="scripts" className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          <p className="max-w-lg text-zinc-400">Each script now has its own info page with video and showcase image support.</p>
        </div>
      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-[1.2fr_0.9fr]">
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950/80 p-4 md:p-6">
          {product.youtubeEmbed ? (
            ...
            <img src={product.imageUrl} alt={`${product.name} preview`} className="w-full rounded-2xl border border-zinc-800 object-cover" />
          )}
          <div className="mt-6">
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-950/80">
            {product.imageUrl ? (
              <img src={product.imageUrl} alt={`${product.name} thumbnail`} className="aspect-video w-full object-cover" />
            ) : (
          ...
          <div className="rounded-3xl border border-zinc-800 bg-zinc-950/80 p-6">
            ...
            <div className="mt-4 grid gap-3">
              ...
              <Link to="/" className="inline-flex justify-center rounded-xl border border-zinc-700 bg-zinc-900/70 px-5 py-3 text-sm font-black text-white">
                Browse More Scripts
              </Link>
            </div>
          </div>
